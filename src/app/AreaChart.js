        ...
        return (
            <ResponsiveContainer width="100%" height={380}>
                ...
                >
                    ...
                    <XAxis hide={false} height={10} dataKey="name" stroke="#FFF" tick={{ fill: '#FFF' }} />
                    <YAxis
                        axisLine={false}
                        tickCount={10}
                        tickLine={false}
                        ...
                        stroke="#FFF" tick={{ fill: '#FFF' }}
                    />

                    <Tooltip
                        content={<CustomTooltip />}
                        cursor={{ stroke: '#C86C00', strokeWidth: 3 }}
                        wrapperStyle={{ color: '#FFF' }} // Set text color to white
                    />
                    <Area
