                        ...
                        <TableBody className="bg-black">
                            {visibleRows.map((row, index) => {
                                ...
                                return (
                                        ...
                                        <TableCell align="right" style={{ color: rowHovered ? '#c86c00' : 'white', padding: '3px', fontSize: '15px' }} className="bg-[#110A01] border-none text-center hidden lg:table-cell hover:text-[#c86c00] transition-colors duration-200">{row.fat}</TableCell>
                                        <TableCell align="right" style={{ color: rowHovered ? '#c86c00' : 'white', padding: '3px', fontSize: '15px' }} className="bg-[#110A01] border-none text-center hidden lg:table-cell hover:text-[#c86c00] transition-colors duration-200">{row.carbs}</TableCell>
                                    </TableRow>
                                );
                            })}
                        </TableBody>
